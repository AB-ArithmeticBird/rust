...
#[cfg(windows)] pub use types::os::arch::extra::{time64_t, OVERLAPPED, PROCESS_TERMINATE};
#[cfg(windows)] pub use types::os::arch::extra::{LPOVERLAPPED};
#[cfg(windows)] pub use types::os::arch::extra::{MOVEFILE_REPLACE_EXISTING};
...
#[cfg(windows)] pub use funcs::extra::kernel32::{MoveFileExW};
